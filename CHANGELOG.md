...
* **patch:** update dependency grafana/loki to v3.7.7 ([#140](https://github.com/rolehippie/loki/issues/140)) ([73adc27](https://github.com/rolehippie/loki/commit/73adc273fa8708af5a37e2574adc707d13d813ad))
* **patch:** update dependency pipx:ansible-doctor to v8.4.1 ([#141](https://github.com/rolehippie/loki/issues/141)) ([b8cf0dc](https://github.com/rolehippie/loki/commit/b8cf0dc60a651c6f5a0962dd8a916c4b45d2e1da))

## [6.4.1](https://github.com/rolehippie/loki/compare/v6.4.0...v6.4.1) (2026-08-24)

### Dependencies

* **patch:** update dependency oauth2-proxy/oauth2-proxy to v7.15.4 ([#139](https://github.com/rolehippie/loki/issues/139)) ([d7d0425](https://github.com/rolehippie/loki/commit/d7d0425ccc9a2b10709134c3bfb916dc0738b811))
...
* **minor:** update dependency community.general to >=13.1.0,<13.2.0 ([#122](https://github.com/rolehippie/loki/issues/122)) ([5fce035](https://github.com/rolehippie/loki/commit/5fce035e1976fdf7d4b08f4e9eefc074fc6bafb6))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([dbeb01a](https://github.com/rolehippie/loki/commit/dbeb01a46f38eb2ae86f73b4fc51443f4615cf92))

## [6.0.1](https://github.com/rolehippie/loki/compare/v6.0.0...v6.0.1) (2026-06-15)

### Dependencies

* **patch:** update version prefix to v7.15.3 ([#121](https://github.com/rolehippie/loki/issues/121)) ([cfdbdd0](https://github.com/rolehippie/loki/commit/cfdbdd0daee53411b756002161b64b80041206ed))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([b5ad740](https://github.com/rolehippie/loki/commit/b5ad7406e1149961ba38102e80c08d1c6fdab571))
* **flake:** updated lockfile [skip ci] ([230d850](https://github.com/rolehippie/loki/commit/230d8505e8c564cba50f41ce1e7d3e79d979c375))
* **flake:** updated lockfile [skip ci] ([7b0513a](https://github.com/rolehippie/loki/commit/7b0513a842a696f221ff0a9ca3beab1903d46610))

## [6.0.0](https://github.com/rolehippie/loki/compare/v5.8.1...v6.0.0) (2026-05-25)

### Dependencies

* **major:** update dependency community.general to v13 ([#120](https://github.com/rolehippie/loki/issues/120)) ([0bc60bd](https://github.com/rolehippie/loki/commit/0bc60bd91adeb42f1bb0c97d218c0fb67dfa5939))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([b5658fd](https://github.com/rolehippie/loki/commit/b5658fd9d8a2eb98cd8d71e8cf636b3932268a4f))
...
* **patch:** update dependency oauth2-proxy/oauth2-proxy to v7.15.2 ([#117](https://github.com/rolehippie/loki/issues/117)) ([58df590](https://github.com/rolehippie/loki/commit/58df5905fcc9c03c6c10095ba1dd4c97bd349857))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([1c30773](https://github.com/rolehippie/loki/commit/1c307736f05847b6899e5dbc3c24a025f5d0ffac))
...
* **minor:** update dependency community.docker to >=5.1.0,<5.2.0 ([#110](https://github.com/rolehippie/loki/issues/110)) ([b5d3a3a](https://github.com/rolehippie/loki/commit/b5d3a3a4e29552d20d8b766e0730aa24f1397dee))
* **minor:** update dependency community.general to >=12.5.0,<12.6.0 ([#111](https://github.com/rolehippie/loki/issues/111)) ([2d28006](https://github.com/rolehippie/loki/commit/2d2800665043404ef2bb43a04398d871ba9bcc9d))
* **minor:** update dependency grafana/loki to v3.7.0 ([#113](https://github.com/rolehippie/loki/issues/113)) ([0b0ff55](https://github.com/rolehippie/loki/commit/0b0ff558d20cd4b8a0d96470b412d090fb130b4d))
* **patch:** update dependency grafana/loki to v3.6.8 ([#112](https://github.com/rolehippie/loki/issues/112)) ([5f20dc5](https://github.com/rolehippie/loki/commit/5f20dc5cc2a6c9686e255080ea7053b10301fc69))
* **patch:** update dependency grafana/loki to v3.7.1 ([#114](https://github.com/rolehippie/loki/issues/114)) ([d58363c](https://github.com/rolehippie/loki/commit/d58363ca223170f6b32c2028ee27a1c050d2cd55))
* **patch:** update dependency oauth2-proxy/oauth2-proxy to v7.15.1 ([#109](https://github.com/rolehippie/loki/issues/109)) ([e251e29](https://github.com/rolehippie/loki/commit/e251e29a58b9fb14805ca6d4d09477ea2a233467))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([86a4b7d](https://github.com/rolehippie/loki/commit/86a4b7dda307adabb2b6bc609b99f53470037c9b))

## [5.5.0](https://github.com/rolehippie/loki/compare/v5.4.0...v5.5.0) (2026-03-23)

### Dependencies

* **minor:** update dependency oauth2-proxy/oauth2-proxy to v7.15.0 ([#107](https://github.com/rolehippie/loki/issues/107)) ([5acb383](https://github.com/rolehippie/loki/commit/5acb38340331b19c4a14f8d979ed6639c93a53c8))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([adcb949](https://github.com/rolehippie/loki/commit/adcb9495858179c0d26cf5204a098d121e0c7d0d))
* **flake:** updated lockfile [skip ci] ([73fd979](https://github.com/rolehippie/loki/commit/73fd979bab7545089d4f49c5ff8cf8740d95bea4))
* **flake:** updated lockfile [skip ci] ([1e04948](https://github.com/rolehippie/loki/commit/1e04948654461f384dc567d9e057e5a78b011510))
...
* **patch:** update dependency grafana/loki to v3.6.6 ([#102](https://github.com/rolehippie/loki/issues/102)) ([eec4119](https://github.com/rolehippie/loki/commit/eec4119b04b6f47f3c08354e6bdef0fdf1ed2843))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([61b8b60](https://github.com/rolehippie/loki/commit/61b8b6092f6c7a1ddd5dce5812b14453a0b06987))
* **flake:** updated lockfile [skip ci] ([c8c83be](https://github.com/rolehippie/loki/commit/c8c83be9c1acc89f2b7930d2b93f0d0861585ee0))

## [5.3.1](https://github.com/rolehippie/loki/compare/v5.3.0...v5.3.1) (2026-02-09)

### Dependencies

* **patch:** update dependency grafana/loki to v3.6.5 ([#101](https://github.com/rolehippie/loki/issues/101)) ([a4a913f](https://github.com/rolehippie/loki/commit/a4a913f9c3158c3b220ebef79b95bce4e2942e30))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([acc8836](https://github.com/rolehippie/loki/commit/acc8836c5879cc98d85bf7de5ddec3ff23ed5716))

## [5.3.0](https://github.com/rolehippie/loki/compare/v5.2.2...v5.3.0) (2026-02-02)

### Dependencies

* **minor:** update dependency community.general to >=12.3.0,<12.4.0 ([#100](https://github.com/rolehippie/loki/issues/100)) ([ebadcca](https://github.com/rolehippie/loki/commit/ebadccab4c056d4b85c655c5b23d149ae9c91f26))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([5de8e4f](https://github.com/rolehippie/loki/commit/5de8e4f6208a8c6b1365605c404fb8f2d20bdf00))

## [5.2.2](https://github.com/rolehippie/loki/compare/v5.2.1...v5.2.2) (2026-01-26)

### Dependencies

* **patch:** update dependency grafana/loki to v3.6.4 ([#99](https://github.com/rolehippie/loki/issues/99)) ([0352b38](https://github.com/rolehippie/loki/commit/0352b38eff1be094f851be531baf638165a2f245))
